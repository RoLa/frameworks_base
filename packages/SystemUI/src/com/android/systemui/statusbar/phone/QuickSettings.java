...
class QuickSettings {
   ...
   // public static final String BT_TETHER_TOGGLE = "BTTETHER";
    ...
    private QuickSettingsTileView getTile(int tile, ViewGroup parent, LayoutInflater inflater) {
		...
		final int tileText = (mUseDefaultTheme ? Color.parseColor("#CCCCCC") : Color.parseColor("#333333"));
            ...
            case USER_TILE:
                ...
                mModel.addUserTile(quick, new QuickSettingsModel.RefreshCallback() {
                    ...
                    public void refreshView(QuickSettingsTileView view, State state) {
						...
						tv.setBackgroundColor(mUseDefaultTheme ? Color.parseColor("#CC000000") : Color.parseColor("#CCffffff"));
    ...
    private void updateSettings() {
        ...
        int columnCount = Settings.System.getInt(resolver, Settings.System.QUICK_TOGGLES_PER_ROW, mContext.getResources().getInteger(R.integer.quick_settings_num_columns));
